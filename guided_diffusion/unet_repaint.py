...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        print("self.attention_resolutions:",self.attention_resolutions)
        print("self.dropout:",self.dropout)
        print("self.channel_mult:",self.channel_mult)
        print("self.conv_resample:",self.conv_resample)
        print("self.num_classes:",self.num_classes)
        print("self.use_checkpoint:",self.use_checkpoint)
        print("self.dtype:",self.dtype)
        print("self.num_heads:",self.num_heads)
        print("self.num_head_channels:",self.num_head_channels)
        print("self.num_heads_upsample:",self.num_heads_upsample)
    ...
    def forward(self, x, timesteps, y=None, gt=None, **kwargs):
        ...
        # print("start of unet:", mem_used_gb)
        ...
        # free, total = th.cuda.mem_get_info(0)
        # mem_used_gb = (total - free) / 1024 ** 3
        # print("emb:", mem_used_gb)
        if self.num_classes is not None:
            assert y.shape == (x.shape[0],)
            emb = emb + self.label_emb(y)
        # free, total = th.cuda.mem_get_info(0)
        # mem_used_gb = (total - free) / 1024 ** 3
        # print("num_classes:", mem_used_gb)
        h = x.type(self.dtype)
        # print(h.shape)
        ...
        # free, total = th.cuda.mem_get_info(0)
        # mem_used_gb = (total - free) / 1024 ** 3
        # print("module input loop:", mem_used_gb)
        ...
        # free, total = th.cuda.mem_get_info(0)
        # mem_used_gb = (total - free) / 1024 ** 3
        # print("module output loop:", mem_used_gb)
        h = h.type(x.dtype)
        # print(x.dtype)
        # h = self.out(h)
