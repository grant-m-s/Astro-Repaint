...
def to_file_ext(img_names, ext):
    ...
    for img_name in img_names:
        ...
        try:
            img_names_out.append(splits[0] + '.' + splits[1])
        except:
            print(img_name,splits)
...
class Default_Conf_Repaint(NoneDict):
    def __init__(self):
        pass
    ...
    def get_dataloader(self, dset='train', dsName=None, batch_size=None, return_dataset=False):
        ...
        if ds_conf.get('mask_loader', False):
            from guided_diffusion.image_datasets_repaint import load_data_inpa
            print("load_data_inpa:")
